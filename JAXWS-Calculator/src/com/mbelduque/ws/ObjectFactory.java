 ...
 * generated in the com.mbelduque.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Operation_QNAME = new QName("http://ws.mbelduque.com/", "operation");
    private final static QName _OperationResponse_QNAME = new QName("http://ws.mbelduque.com/", "operationResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mbelduque.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.mbelduque.com/", name = "operation")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.mbelduque.com/", name = "operationResponse")
